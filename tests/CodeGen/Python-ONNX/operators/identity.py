...
def generate_identity_model(input_names, output_names):
    """Generate Identity operator model."""
    initializers = []
    ...
    node = helper.make_node("Identity", inputs=[input_names[0]], outputs=[output_names[0]], 
                            name="Identity_node")
