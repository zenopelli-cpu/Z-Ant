...
def generate_sigmoid_model(input_names, output_names):
    """
    Generates a Sigmoid operator model.
    """
    initializers = []
    ...
    node = helper.make_node("Sigmoid", inputs=[input_names[0]], outputs=[output_names[0]], 
                            name=f"Sigmoid_node")
