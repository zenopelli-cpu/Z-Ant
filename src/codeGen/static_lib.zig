...
tensor_layer1_weight = Tensor(f32).fromArray(&fba, &array_layer1_weight, &shape_tensor_layer1_weight);
...
tensor_layer1_bias = Tensor(f32).fromArray(&fba, &array_layer1_bias, &shape_tensor_layer1_bias);
...
tensor_layer2_weight = Tensor(f32).fromArray(&fba, &array_layer2_weight, &shape_tensor_layer2_weight);
...
tensor_layer2_bias = Tensor(f32).fromArray(&fba, &array_layer2_bias, &shape_tensor_layer2_bias);
 } 
...
tensor__layer1_gemm_output_0 = Tensor(f32).fromShape(&fba, &shape_tensor__layer1_gemm_output_0);

var shape_tensor__relu_relu_output_0 : [1]usize = [_]usize{ 5} ;
tensor__relu_relu_output_0 = Tensor(f32).fromShape(&fba, &shape_tensor__relu_relu_output_0);

var shape_tensor__layer2_gemm_output_0 : [1]usize = [_]usize{ 5} ;
tensor__layer2_gemm_output_0 = Tensor(f32).fromShape(&fba, &shape_tensor__layer2_gemm_output_0);

var shape_tensor__relu_1_relu_output_0 : [1]usize = [_]usize{ 5} ;
tensor__relu_1_relu_output_0 = Tensor(f32).fromShape(&fba, &shape_tensor__relu_1_relu_output_0);

var shape_tensor_output : [1]usize = [_]usize{ 5} ;
tensor_output = Tensor(f32).fromShape(&fba, &shape_tensor_output);
 }
