...
pub const Sqrt = struct {
    ...
    pub fn init(nodeProto: *NodeProto) !Sqrt {
    ...
    pub fn get_output_shape(self: Sqrt) []usize {
        return self.output_Y.getShape();
    }

    pub fn get_input_tensors(self: Sqrt) ![]*TensorZant {
    ...
    pub fn get_output_tensors(self: Sqrt) ![]*TensorZant {
    ...
    pub fn compute_output_shape(self: Sqrt) []usize {
        var output_shape: []usize = undefined;
        output_shape = try tensorMath.get_sqrt_output_shape(self.input_X.ptr.?.get_shape());
        self.output_Y.shape = output_shape;
        return output_shape;
    }

    pub fn write_op(self: Sqrt, writer: std.fs.File.Writer) !void {
