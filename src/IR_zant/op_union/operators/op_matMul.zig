...
pub const MatMul = struct {
    ...
    pub fn sobstitute_tensors(self: *MatMul, old_tensor: *TensorZant, new_tensor: *TensorZant) !void {
    ...
    pub fn render_lower(self: MatMul, builder: *UOpBuilder) !void {
