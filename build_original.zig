...
pub fn build(b: *std.Build) void {
    ...
    const layer_mod = b.createModule(.{ .root_source_file = b.path("src/Model/layers/layer.zig") });
    ...
    // Loop through all the modules and add them as imports to the unit test module.
    // This is done to ensure that all the modules are available for testing.
