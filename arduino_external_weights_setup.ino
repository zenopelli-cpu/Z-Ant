// Esempio sketch Arduino per Nicla Vision con pesi esterni
// File: arduino_external_weights_setup.ino

#include <stdint.h>
#include <cstring>

// Dichiarazioni per le funzioni Zant
extern "C" {
...
1. Modifica il codice generato per usare caricamento dinamico
